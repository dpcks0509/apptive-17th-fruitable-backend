...
public class MemberService {
    ...
    public Long save(MemberDto memberDto) throws Exception {
        ...
        Long savedN = memberRepository.save(memberEntity).getN();
        return savedN;
    }
    ...
    public MemberDto findByN(Long n) {
        Optional<MemberEntity> optionalMemberEntity =  memberRepository.findByN(n);
        if(optionalMemberEntity.isPresent()) {
